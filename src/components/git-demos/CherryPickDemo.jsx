  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        <code>hotfix</code> has one commit main needs urgently, but the rest
        of hotfix isn't ready. <code>git cherry-pick</code> copies just that
        one commit onto main, as a new commit with the same changes.
      </p>
