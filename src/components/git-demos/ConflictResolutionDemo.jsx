  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        ...
        can't guess which version you want, so it marks the conflict in the
        file and pauses the merge until you resolve it.
      </p>
...
>>>>>>> feature`}</CodeBlock>
      ...
      {committed && (
        <p className="text-sm text-muted mt-4">
          ...
          <code>git commit</code> finishes the merge with no extra flags
          needed.
        </p>
      )}
    </div>
