  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        A <code>.gitignore</code> file lists patterns for files Git should
        never track - build output, dependencies, secrets. Add a pattern and
        watch it disappear from <code>git status</code> below.
      </p>
