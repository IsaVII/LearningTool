  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        ...
        <code>HEAD</code> backwards and rewrites local history -{" "}
        <em>never</em> do this on a branch others have already pulled.{" "}
        <code>revert</code> adds a new commit that undoes the old one, so
        it's safe to share.
      </p>
