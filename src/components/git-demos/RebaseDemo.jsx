...
const FEATURE_ORIGINAL = ["Initial commit", "Add login form", "Style login form"];
  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        ...
        current tip, rewriting their hashes but keeping history linear -
        instead of the merge commit a <code>git merge</code> would create.
      </p>
