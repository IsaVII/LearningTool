  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        <code>bcrypt.hash()</code> turns a password into a one-way, salted
        hash - the same password hashed twice even produces different output
        because of the random salt, and there's no way to reverse a hash back
        into the original password. Login re-hashes the submitted password
        and compares hashes, never plain text.
      </p>
