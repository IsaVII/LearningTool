  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        An auth middleware runs before the route handler and decides whether
        the request even gets there. It's the same middleware-chain idea as
        logging or body parsing - the only difference is this one can end the
        request early with a 401 instead of calling <code>next()</code>.
      </p>
