  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        Server-Sent Events give you a one-way stream from server to client
        over a single long-lived HTTP connection - simpler than a WebSocket
        when the client never needs to send anything back, like a live price
        ticker or a notifications feed.
      </p>
