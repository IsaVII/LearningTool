  ...
  return (
    <div className="bg-surface-alt border border-line rounded p-6">
      <p className="text-muted mb-4">
        CORS is enforced by the <em>browser</em>, not the server - the
        response actually arrives either way, but the browser only lets your
        script read it if the server's <code>Access-Control-Allow-Origin</code>{" "}
        header matches. Methods other than GET/POST with simple headers (like
        PUT) also trigger a preflight <code>OPTIONS</code> check first.
      </p>
