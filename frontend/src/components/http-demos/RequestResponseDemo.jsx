...
const STAGES = [
  { delay: 0, text: "1. DNS lookup - resolve api.example.com to an IP address" },
  { delay: 400, text: "2. TCP + TLS handshake - open a secure connection to the server" },
  {
    delay: 800,
    text: '3. Request sent - "GET /users/7 HTTP/1.1" plus headers',
  },
  { delay: 1300, text: "4. Server processes the request (reads a database, etc.)" },
  {
    delay: 2000,
